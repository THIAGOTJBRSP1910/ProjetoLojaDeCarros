...
if (!empty($data->codigoVeiculo) && !empty($data->quant) && !empty($data->prcUnitario)){ //"!" - é uma negação 
    ...
    if($tb_carrinho->atualizar()){
        header("HTTP/1.0 200");
        echo json_encode(array("mensagem"=>"Carrinho atualizado com sucesso!"));
