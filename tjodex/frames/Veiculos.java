...
public class Veiculos extends JFrame {
  ...
  //metodo para setar os campos do formulario com o conteudo da tabela
	...
	private void adicionar() {
		String create = "insert into tb_produtos(codigoProd, marca, modelo, ano, preco, kilometragem, cambio, carroceria, combustivel, finalPLaca, cor, ipvaPago, estoque) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
		try {
	...
	String delete = "delete from tb_produtos where codigoProd=?";
	...
	private void atualizar() {
	    ...
	    String update = "update tb_produtos set marca=?, modelo=?, ano=?, preco=?, kilometragem=?, cambio=?, carroceria=?, combustivel=?, finalPLaca=?, cor=?, ipvaPago=?, estoque=? where codigoProd =?";
		try {
